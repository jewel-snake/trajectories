...
fn law(instance: Vector6d) -> Vector6d {
    ...
    let fi_s = fi_b(instance.position_mag()) + fi_d(r,instance.z) + fi_h(instance.position_mag());
    let fi_s_dr = fi_b(((r+100.0).powi(2)+instance.z.powi(2)).sqrt()) + fi_d(r+100.0,instance.z) + fi_h(((r+100.0).powi(2)+instance.z.powi(2)).sqrt());
    let fi_s_dz = fi_b((r.powi(2)+(instance.z+100.0).powi(2)).sqrt()) + fi_d(r,instance.z+100.0) + fi_h((r.powi(2)+(instance.z+100.0).powi(2)).sqrt());
    Vector6d {
        x:0.0,y:0.0,z:0.0,
        m:(fi_s_dr-fi_s)/100.0,
        n:(fi_s_dr-fi_s)/100.0,
        k:(fi_s_dz-fi_s)/100.0
    }
}
...
fn dm_dt(instance: Vector6d) -> Vector6d {
    ...
    let accel = law(instance)*2.325e7/100.0;//* 1.0749776097859195e-11* 1.022018688e-6_f64.powi(2)*2.325e7_f64/100.0
